...
$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('images/logo.png','Thân gửi cô Vương Tiểu Oanh, ','Chúng em có 1 món quà nhỏ muốn dành tặng cô, đó là 1 mini game tự làm 1 chiếc bánh. Cô bấm nút "Click here" bên dưới nha cô');
